...
\label{sec:ned-functions:category-python}

\begin{description}
\item[pycode]: \ttt{any pycode(string s, ...)} \\
    evaluates the string as if it was a Python function body

\item[pyeval]: \ttt{any pyeval(string s, ...)} \\
    evaluates the string as a Python expression; or as if it was a Python
    lambda, then calls it
