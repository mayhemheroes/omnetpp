...
\item[output-scalar-precision] = \textit{<int>}, default: \ttt{17}\\
    \textit{Per-simulation-run setting.}\\
...
\item[output-vector-file-append] = \textit{<bool>}, default: \ttt{false}\\
    ...
    appending.
\item[output-vector-precision] = \textit{<int>}, default: \ttt{17}\\
    \textit{Per-simulation-run setting.}\\
...
\item[rngmanager-class] = \textit{<string>}, default: \ttt{omnetpp::{\allowbreak}cRng\-Manager}\\
    \textit{Per-simulation-run setting.}\\
    Part of the Envir plugin mechanism: selects the RNG manager class to be
    used for providing RNGs to modules and channels. The class has to implement
    the \ttt{cIRng\-Manager} interface.
