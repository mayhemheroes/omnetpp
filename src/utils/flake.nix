    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        fhsEnv = pkgs.buildFHSEnv {
            ...
            profile = ''
              export name="omnetpp-fhs-env" # important because it is used in install.sh to skip dependency installation
      ...
      in
      {
        ...
        devShells = {
          ...
          native = (pkgs.mkShell.override { stdenv = pkgs.clangStdenv; }) {
            name = "omnetpp-nix"; # important because it is used in install.sh to skip dependency installation
