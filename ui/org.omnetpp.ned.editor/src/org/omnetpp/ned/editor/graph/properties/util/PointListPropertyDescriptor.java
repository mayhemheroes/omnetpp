...
import org.omnetpp.ned.editor.graph.dialogs.PointListDialog;

public class PointListPropertyDescriptor extends PropertyDescriptor {

    private static String pointListToString(List<Point> pointList) {
    ...
    private static List<Point> stringToPointList(String string) {
    ...
    class PointListLabelProvider extends LabelProvider {
        @SuppressWarnings("unchecked")
        public String getText(Object element) {
            return pointListToString((List<Point>)element);
        }
    }
    ...
    public PointListPropertyDescriptor(Object id, String displayName) {
        ...
        setValidator(new PointListValidator());
    }

    class PointListValidator implements ICellEditorValidator {
        ...
        public String isValid(Object value) {
            if (value instanceof List<?>) {
                ...
                List<Point> list = stringToPointList((String)value);
    ...
    class PointListCellEditor extends TextCellEditorEx {
        ...
        protected void doSetValue(Object value) {
            super.doSetValue(pointListToString((List<Point>)value));
        }

        @Override
        protected Object doGetValue() {
            return stringToPointList((String)super.doGetValue());
        }
        ...
        protected Object openDialogBox(Control cellEditorWindow) {
            ...
            PointListDialog dialog = new PointListDialog(cellEditorWindow.getShell(), newList);
