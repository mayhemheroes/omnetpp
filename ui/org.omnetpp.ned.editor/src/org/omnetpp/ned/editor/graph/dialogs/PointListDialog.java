...
public class PointListDialog extends Dialog {
    ...
    private final class PointListTableLabelProvider extends TableLabelProvider {
        @Override
     ...
     * Creates the dialog.
     */
    public PointListDialog(Shell parentShell, List<Point> pointList) {
        super(parentShell);
    ...
    private void addEditButtons(Composite composite) {
        ...
        addButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                pointList.add(selectedLine + 1, newPoint);
                listViewer.refresh();
    ...
    private TableViewer createAndConfigureTable(Composite parent) {
        ...
        tableViewer.setLabelProvider(new PointListTableLabelProvider());
        ...
        tableViewer.setInput(pointList);
        return tableViewer;
    }
