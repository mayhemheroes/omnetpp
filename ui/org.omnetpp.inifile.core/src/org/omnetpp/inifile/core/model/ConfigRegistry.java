...
import static org.omnetpp.inifile.core.model.ConfigOption.DataType.CFG_BOOL;
import static org.omnetpp.inifile.core.model.ConfigOption.DataType.CFG_CUSTOM;
import static org.omnetpp.inifile.core.model.ConfigOption.DataType.CFG_DOUBLE;
import static org.omnetpp.inifile.core.model.ConfigOption.DataType.CFG_FILENAME;
import static org.omnetpp.inifile.core.model.ConfigOption.DataType.CFG_FILENAMES;
import static org.omnetpp.inifile.core.model.ConfigOption.DataType.CFG_INT;
import static org.omnetpp.inifile.core.model.ConfigOption.DataType.CFG_PATH;
import static org.omnetpp.inifile.core.model.ConfigOption.DataType.CFG_STRING;
import static org.omnetpp.inifile.core.model.ConfigOption.ObjectKind.KIND_COMPONENT;
import static org.omnetpp.inifile.core.model.ConfigOption.ObjectKind.KIND_MODULE;
import static org.omnetpp.inifile.core.model.ConfigOption.ObjectKind.KIND_PARAMETER;
import static org.omnetpp.inifile.core.model.ConfigOption.ObjectKind.KIND_SCALAR;
import static org.omnetpp.inifile.core.model.ConfigOption.ObjectKind.KIND_SIMPLE_MODULE;
import static org.omnetpp.inifile.core.model.ConfigOption.ObjectKind.KIND_STATISTIC;
import static org.omnetpp.inifile.core.model.ConfigOption.ObjectKind.KIND_UNSPECIFIED_TYPE;
import static org.omnetpp.inifile.core.model.ConfigOption.ObjectKind.KIND_VECTOR;
...
public class ConfigRegistry {
    ...
    // IMPORTANT!  When updating this, forms must also be updated with the missing options.
    ...
    public static final ConfigOption CFGID_CONFIG_RECORDING = addPerRunOption(
        "config-recording", CFG_CUSTOM, "all",
    ...
    public static final ConfigOption CFGID_DEBUG_ON_ERRORS = addPerRunOption(
    ...
    public static final ConfigOption CFGID_FINGERPRINT_RESULTS = addPerRunOption(
        ...
        "you configured multiple fingerprints, separate filters with commas.");
    public static final ConfigOption CFGID_FINGERPRINTCALCULATOR_CLASS = addPerRunOption(
    ...
    public static final ConfigOption CFGID_FUTUREEVENTSET_CLASS = addPerRunOption(
    ...
    public static final ConfigOption CFGID_NED_PACKAGE_EXCLUSIONS = addGlobalOption(
        "ned-package-exclusions", CFG_CUSTOM, null,
    ...
    public static final ConfigOption CFGID_OUTPUTSCALARMANAGER_CLASS = addPerRunOption(
        "outputscalarmanager-class", CFG_STRING, "omnetpp::envir::OmnetppOutputScalarManager",
    ...
    public static final ConfigOption CFGID_OUTPUTVECTORMANAGER_CLASS = addPerRunOption(
        "outputvectormanager-class", CFG_STRING, "omnetpp::envir::OmnetppOutputVectorManager",
    ...
    public static final ConfigOption CFGID_PARAM_RECORDING = addPerObjectOption(
        "param-recording", KIND_PARAMETER, CFG_BOOL, "true",
    ...
    public static final ConfigOption CFGID_PARSIM_NUM_PARTITIONS = addGlobalOption(
        "parsim-num-partitions", CFG_INT, null,
    ...
    public static final ConfigOption CFGID_RESULTDIR_SUBDIVISION = addPerRunOption(
        "resultdir-subdivision", CFG_BOOL, "false",
    ...
    public static final ConfigOption CFGID_SCHEDULER_CLASS = addPerRunOption(
    ...
    public static final ConfigOption CFGID_SNAPSHOTMANAGER_CLASS = addPerRunOption(
        "snapshotmanager-class", CFG_STRING, "omnetpp::envir::FileSnapshotManager",
    ...
    public static final String CFGVAR_DATETIMEF = addConfigVariable("datetimef", "Like ${datetime}, but sanitized for use as part of a file name");
    ...
    static {
        InifileCorePlugin.getDefault().getPreferenceStore().addPropertyChangeListener((e) -> ignoredOptions = null); // invalidate on change
    }

    public static Set<String> getIgnoredOptions() {
        if (ignoredOptions == null) {
            String pref = InifileCorePlugin.getDefault().getPreferenceStore().getString(PREF_IGNORED_OPTIONS);
    ...
    public static void addIgnoredOption(String option) {
        ...
        InifileCorePlugin.getDefault().getPreferenceStore().setValue(PREF_IGNORED_OPTIONS, StringUtils.join(ignoredOptions, " "));
    }
